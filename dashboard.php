...
// for ($i = 0; $i < count($masterDatabaseName); $i++) {
//     $databaseName = $masterDatabaseName[$i]['Database'];
//     $sql1 = "SELECT table_name,table_schema FROM information_schema.tables WHERE table_schema = '$databaseName';";
//     // echo $sql1;
//     $results = mysqli_query($conn1, $sql1);

//     if (!empty($results) && $results->num_rows > 0) {
//         while ($row1 = $results->fetch_assoc()) {
//             array_push($masterTableName, $row1);
//         }
//     }
// }

// print_r($masterTableName);
// echo $masterDatabaseName[1]['Database'];
            ...
            <div class="col-md-3 rigthHr" style="background-color: #023f56;">
                <div class="col-12 text-center">
                    <i id="dbBack" class="fa fa-arrow-left headIcon" onclick="loadDatabaseName()" hidden></i>
                     <button class="btn btn-primary text-center mb-2" style="margin-right: 7px !important;" id='databaseHeading'>SCHEMAS <i class="fa-solid fa-database" style="margin-left: 10px;color: greenyellow;"></i></button>
...
<script src="js/htmlToPdf.js?v=<?php echo rand(); ?>"></script>
...
<script>
    ...
    // function loadTableName(databaseName) {
